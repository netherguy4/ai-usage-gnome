...
По одному числу на аккаунт: пятичасовой лимит, а если у тарифа его нет (например, Codex `plus`) — недельный. Остальные лимиты, включая привязанные к моделям, видны в меню.
