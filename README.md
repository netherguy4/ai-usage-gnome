...
По одному числу на аккаунт: пятичасовой лимит, а если у тарифа его нет (например, Codex `plus`) — недельный. У провайдеров без лимитов, как DeepSeek, показывается баланс. Остальные лимиты, включая привязанные к моделям, видны в меню.

Минимум по всем лимитам не подошёл: исчерпанный лимит отдельной модели показывал бы 0%, хотя работать ещё можно.
